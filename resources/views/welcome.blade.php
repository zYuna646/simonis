                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('landing') }}" class="text-gray-600 hover:text-[var(--color-royal-blue-600)]">Home</a>
                            ...
                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ url('/dashboard') }}" class="bg-[var(--color-royal-blue-600)] hover:bg-[var(--color-royal-blue-700)] text-white px-4 py-2 rounded-md">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}" class="text-gray-600 hover:text-[var(--color-royal-blue-600)]">Login</a>
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="bg-[var(--color-royal-blue-600)] hover:bg-[var(--color-royal-blue-700)] text-white px-4 py-2 rounded-md">Register</a>
                                    @endif
                                @endauth
                            @endif
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2">
                                <li><a href="#" class="text-gray-300 hover:text-white"><i class="fab fa-twitter mr-2"></i>Twitter</a></li>
                                <li><a href="#" class="text-gray-300 hover:text-white"><i class="fab fa-facebook mr-2"></i>Facebook</a></li>
                                <li><a href="#" class="text-gray-300 hover:text-white"><i class="fab fa-instagram mr-2"></i>Instagram</a></li>
                                <li><a href="#" class="text-gray-300 hover:text-white"><i class="fab fa-linkedin mr-2"></i>LinkedIn</a></li>
                            </ul>
                        </div>
                    </div>
